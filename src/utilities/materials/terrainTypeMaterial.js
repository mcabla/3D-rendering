...
export const terrainTypeMaterial = new THREE.ShaderMaterial({
    uniforms: {
        ...
        stoneAngle: { type: "float", value: 0.6 },
        grassAngle: { type: "float", value: 0.9 },
        waterLevel: { type: "float", value: 0.01 },
        surfaceLevel: { type: "float", value: 0.09 }
    },
    vertexShader: /* glsl */`
        varying vec2 vUv;
    ...
    fragmentShader: /* glsl */`
        ...
        void main() {            
            ...
            vec4 heightTexel = mix(sandTexel, grassTexel, step(surfaceLevel, vPosition.y));
            
            vec4 texel = mix(stoneTexel, heightTexel, step(grassAngle, angle)); 
